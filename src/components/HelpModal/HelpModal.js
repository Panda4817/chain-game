						...
						<div className="container">
                            <div className="row justify-content-center">
								<div className="col text-center">
                                    ...
                                    <img class="border border-light" src={start} alt='start' width="100%"/>
                                    ...
                                    <img class="border border-light" src={next} alt='next'  width="100%"/>
                                    ...
                                    <img class="border border-light" src={chain} alt='chain'  width="100%"/>
