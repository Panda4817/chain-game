...
import "../GameOverModal/Modal.css";
						...
						<div className="container">
                            <div className="row justify-content-center">
								<div className="col text-center">
                                    ...
                                    <p>2. The house you choose must have a <strong>lower or equal</strong> price to the owner's <strong>house price and savings combined.</strong></p>
                                    ...
                                    <img src={next} alt='next'  width="80%"/>
                                    ...
                                    <img src={chain} alt='chain'  width="50%"/>
                                    <p>All of the orange houses are only sold, when the <strong>first house you strated with is also sold</strong> to complete the housing chain.</p>
